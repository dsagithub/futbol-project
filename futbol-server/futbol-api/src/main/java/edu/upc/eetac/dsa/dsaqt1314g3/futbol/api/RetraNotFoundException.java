...
public class RetraNotFoundException extends WebApplicationException {
	private final static String MESSAGE = "Retransmision not found";

	public RetraNotFoundException() {
		super(Response
